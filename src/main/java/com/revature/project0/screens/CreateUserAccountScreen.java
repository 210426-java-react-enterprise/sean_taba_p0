...
import com.revature.project0.utilities.DAO;
...
//
//            System.out.println("City (2 - 10 alphabetic):");
//            readLine = scanner.nextLine();
//            String city = InputValidator.validate(readLine, "/city");
//            if (city == null) return;
//
//            System.out.println("State (2 - 10 alphabetic):");
//            readLine = scanner.nextLine();
//            String state = InputValidator.validate(readLine, "/city");
